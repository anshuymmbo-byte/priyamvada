<?php
$page_title = "About | Priyamvada Singh";
$page_description = "Learn about Priyamvada Singh — Tarot Mentor, Spiritual Guide, and Educator with 8+ years of experience.";
include 'header.php';
?>
  ...
  <div class="container">
    <div class="about-intro-grid">
      ...
      <div class="about-intro-content">
        ...
        <a href="contact.php" class="btn btn-primary">Book a Session with Me →</a>
      </div>
    </div>
  </div>
</section>
...
<!-- STATS -->
<section class="section-pad-sm" style="background:var(--rose);padding:48px 0;">
  <div class="container">
...
<!-- JOURNEY TIMELINE -->
<section class="section-pad journey-section">
  <div class="container">
    <div class="text-center" style="margin-bottom:56px;">
      <span class="eyebrow">My Journey</span>
      <h2 class="section-title">How I Got Here</h2>
      <p class="section-subtitle">A path of self-discovery, learning, and service that led me to my calling.</p>
    </div>
...
<!-- CERTIFICATIONS -->
<section class="section-pad" style="background:var(--rose-pale);">
  <div class="container text-center">
    <span class="eyebrow">Credentials</span>
    <h2 class="section-title">Certifications &amp; Training</h2>
    <p class="section-subtitle">My credentials reflect years of dedicated learning and practice.</p>
    <div class="cards-grid" style="max-width:900px;margin:0 auto;">
      <div class="card">
        <div class="card-icon">🎓</div>
        <h3>Certified Tarot Reader</h3>
        <p>Advanced certification in Rider-Waite-Smith Tarot interpretation and spreads.</p>
      </div>
      <div class="card">
        <div class="card-icon">🌿</div>
        <h3>Spiritual Counselor</h3>
        <p>Trained in holistic spiritual counseling, combining intuitive guidance with psychological principles.</p>
      </div>
      <div class="card">
        <div class="card-icon">✨</div>
        <h3>Oracle Card Practitioner</h3>
        <p>Certified in multiple Oracle card systems including Goddess Guidance and Angel Oracle decks.</p>
      </div>
    </div>
  </div>
</section>
